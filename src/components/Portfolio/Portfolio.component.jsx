...
const Portfolio = () => {
    return(
        ...
        <div className="portfolio-content" data-aos="fade-right">
            ...
            <PortfolioCard img={"https://screenshot-proxy.netlify.app/f_avif,w_336/https://d33wubrfki0l68.cloudfront.net/636388b366855f53f95398d5/screenshot_2022-11-03-09-25-27-0000.png"} text={"Demo POS App"} link1={"https://demopos.netlify.app/home"} link2={"https://github.com/aslantasezgin/monster-hunter"}></PortfolioCard>
